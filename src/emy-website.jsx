...
const WHAT_I_DO = [
  { slug:"flights",             icon:"ti-plane",        title:"Flights, private jets & helicopters", pageTitle:"Flights", subtitle:"Scheduled, chartered & beyond", desc:"From a first-class ticket to a chartered jet. A last-minute change or a last-minute trip, we take care of it. Ten years of aviation expertise, and the network to match.", longDesc:"Scheduled flights, private jets, helicopters, hot air balloons, or a scenic flight just for the thrill of it, we arrange it all. Over ten years of aviation expertise, and a worldwide network to match.", examples:[], photos:["/services/flights/victoria-falls-1.jpg","/services/flights/hot-air-balloon-1.jpg","/services/flights/jet-dog-1.jpg"] },
    ...
    <div style={baseStyle}>
      ...
      <div style={{ minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center", opacity:mounted?1:0, transition:"opacity 1s ease" }}>
        <div style={{ textAlign:"center" }}>
          <Logo width={420}/>
          <div style={{ marginTop:20, fontSize:26, fontFamily:"'Montserrat',sans-serif", fontWeight:300, letterSpacing:"0.06em", color:"rgba(255,255,255,0.32)" }}>
